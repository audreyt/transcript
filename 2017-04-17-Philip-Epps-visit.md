...
### Audrey Tang:
No, it’s not. It’s not. You need to, exactly, but this is part of it, because if you qualify for a special professional, your so‑called gold card, then actually, it makes it much easier. We’re mostly talking about, it’s not quite O‑3 or O‑1 visa, like in US, which requires a much higher...
