...
### TTcat：
Just add one point: For certain controversy topics, there would be a lot of people join to the debate, those model they mention should work well. But for those topics is not so popular, how you get people focus for a certain amount of time to talk would be a challenge.
