...
### Audrey Tang:
It makes alliance, it makes people more friendly, but it doesn’t really transform their workflow. It becomes an extra workflow that’s more efficient for some cases, but it doesn’t really change their core or their workflow.
...
### Audrey Tang:
Because the PDIS, the Public Digital Innovation Space here, our first hires are an interaction designer, and then next we have a service designer who came from RCA, from the Policy Lab in the UK. Then we expanded by having a lot of service design methodologies.
...
### Audrey Tang:
This is brilliant, because even people who are not planning to have an Estonian company nevertheless find it cool to engage.
...
### Sandra Ng:
Obviously, we can cover from a local perspective. Basically, we’re global. Our HQ is in Boston. We’re an information provider, and technology is obviously our strength and our focus, which is why we’re familiar with Silicon Valley, and Apple, because obviously, they are one of our customers.
