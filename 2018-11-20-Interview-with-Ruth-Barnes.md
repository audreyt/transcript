...
### Audrey Tang:
It is an open space technology recursively applied to a consultation process. That’s the first distinguishing feature.
...
### Audrey Tang:
The third thing that distinguishes, that it is entirely free and open-source. It runs on a software stack that can be entirely replicated and it could be owned by any people who deploy it. It is not colonial in nature.
...
### Audrey Tang:
Yes, have a good local time, as well, we say around here.
