...
### Audrey Tang:
Based on the civil IoT, for example, we have a annual Presidential Hackathon where we ask the people to solve the society problem based on this data. For example, last year there’s an AI team that used the SCADA data for the water pipelines to detect leakage early, and with a 70 percent accuracy.
