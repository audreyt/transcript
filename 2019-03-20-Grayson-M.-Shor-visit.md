...
### Audrey Tang:
They have the AI fellowship program. As far I understand, they’re also in the talks to join the LEAP project and other important projects. While we are positioning ourselves to be an AI innovation island, of course, Uber is a very valuable partner.
...
### Audrey Tang:
There is an Uber Taxi option that I actually...There is a lot of visibility on this issue, but not particularly because Uber positioned itself as a rental car company. It’s not.
...
### Audrey Tang:
Those self driving tricycles fit into the various workflows that people have when buying flowers in the nearby flowers market or whatever, always with an aim of co creating the norms of how to integrate these creatures. Like co domesticate with the society instead of having random people, random IT dictating what the local people have to do, which is the same approach we took with Uber, actually, with a public consultation.
...
### Audrey Tang:
What the government’s role is, instead of beating them, we join them, which is very rare in Asia. \[laughs\] If they ask, for example, in the industrial parks and areas where it’s less likely for them to go in and install the air boxes, we actually do it through our EPA program and hang it on the lampposts.
...
### Audrey Tang:
Basically, we’re complementary to the civil society offerings of the air box project. If you want to know more details it’s all in the collective intelligence program, ci.taiwan.gov.tw.
...
### Audrey Tang:
Like for the air box example, we also worked with universities to develop blockchains so that when they upload their numbers into the national high speed computing center it’s snapshotted and checked into the blockchain so people can trust the government to not alter their numbers. That builds trust, and once there’s trust there’s effective partnership.

### Audrey Tang:
Based on the civil IoT, for example, we have an annual Presidential Hackathon where we ask the people to solve the society problem based on this data. For example, last year there’s an AI team that used the SCADA data for the water pipelines to detect leakage early, and with a 70 percent accuracy.
...
### Audrey Tang:
They’re badly in need of regulatory adjustment because they can’t oversea become an oil selling company, but if we make that case work, it’s very encouraging for things pushing forward.
...
### Audrey Tang:
Now we’re rolling out a plan that you cannot, for indoor dining and whatever, use plastic straws for drinks. It’s an important step for it. There’s many civics teachers. There’s many people in this year’s new curriculum in all the different levels.
...
### Audrey Tang:
By the time Airbnb was deliberated, Airbnb sent an email to all their Taiwan members to ask them to come to vTaiwan and support the party line of the Airbnb. Because this is an open ended survey, it’s not just a binary one or two, or yes or no. If that was the case, the mobilization might have worked.
...
### Audrey Tang:
This holistic picture image is a regulative thought that, if people hold those patterns in their minds, it prompts a long term thinking that Taiwan, in the political landscape, really needs. If we think in an inter generational, cross generational way, then a lot of the tension that’s born out of people growing up with dictatorship and people born with democracy can dissolve itself.
...
### Audrey Tang:
If their citizens don’t yet demand a certain thing to be under EPR, they don’t tend to be too progressive. That’s the case with municipalities. The central government, the supreme court, \[laughs\] many other organs have an incentive of bringing the society forward.
