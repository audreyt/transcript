...
And so, in the context of online social media, for example, there's now more and more social media trying out community notes, which is instead of just showing the most viral post that stirred up outrage and so on, it's now crowdsourcing what is the most helpful local context to attach to a viral node. And the most viral node is then accomplished with something that's called the uncommon ground, which is people who usually disagree, manage to agree that some notes are helpful. And this kind of bridging map is a much more accurate group selfie because it shows what difference there are in different groups, what splits us, but also what unifies us despite the splitting.
