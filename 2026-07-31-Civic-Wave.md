...
Civic.ai, right? It is a website — [`civic.ai`](https://civic.ai/manifesto/ "Tang, Audrey. “6-Pack of Care: A Manifesto.” civic.ai, 1 Sep 2025.") — with a beautiful [manga illustration](https://civic.ai/comics/ "Civic AI. “6-Pack Comics.” Civic AI, n.d."). The manga does a better job than I do, but I’ll try.
...
Fourth is [**responsiveness**](https://civic.ai/4/ "Tang, Audrey, and Caroline Green. “Pack 4: Responsiveness — Care-Receiving.” Civic AI, n.d."). If your child grows up, at some point they no longer need the kind of care you are used to providing. Sometimes you need to let go. When the need changes, so should the care.
...
The same applies to AI. A school cannot budget for an Nvidia data centre, but it can use an idle computer classroom as a decentralised fine-tuning cluster for a [**Kami**](https://civic.ai/inside-the-kami/ "Civic AI. “Inside the Kami.” Civic AI, n.d."). Post-training and the evolution of AI skills can run on CPUs for little more than the cost of electricity.
